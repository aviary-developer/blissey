@extends('principal')
@section('layout')
  {!!Form::open(['id'=>'guardarResultadosExamen','class' =>'form-horizontal form-label-left input_mask','url' =>'guardarResultadosExamen','method' =>'POST','autocomplete'=>'off','enctype'=>'multipart/form-data'])!!}
  @php
  ...
  <div class="col-md-10">
    ...
    <div class="x_panel">
      <center>
        {!! Form::button('Guardar',['id'=>'guardarLaEvaluacion','class'=>'btn btn-primary btn-sm']) !!}
...
<script>
$("#guardarLaEvaluacion").on("click", function (e) {
  var parametros=[];
  var resultados=[];
  var valoresMinimos=[];
  var valoresMaximos=[];
