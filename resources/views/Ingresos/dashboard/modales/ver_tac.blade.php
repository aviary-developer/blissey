    ...
    <div class="row">
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-xs-12">
                  ...
                  @endphp
                  {!! Form::date('fechaNacimiento',$fecha->format('Y-m-d'),['id'=>'fecha_tac','max'=>$dias_x->format('Y-m-d'),'min'=>$dias_i->format('Y-m-d'),'class'=>'form-control has-feedback-left']) !!}
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-xs-7">
        <div class="x_panel m_panel" style="height: 553px">
          ...
          <div class="row">
            <center>
              <h5 class="big-text" id="date_t">Fecha</h5>
            </center>
          </div>
          <div class="row " >
