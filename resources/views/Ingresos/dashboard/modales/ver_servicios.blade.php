<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="ver_servicios" data-backdrop="static">
  <div class="modal-dialog modal-lg">
      ...
      <div class="x_panel m_panel text-danger">
        <center>
          <h4 class="mb-1">
            ...
            <button type="button" class="btn btn-sm btn-light float-right" id="s-earch-s" title="Búsqueda">
    ...
    <div class="row">
      <div class="x_panel m_panel" id="div_h" style="display:none;">
        <div class="flex-row">
          <center>
            <h5>Búsqueda</h5>
          </center>
        ...
        <div class="form-group col-sm-12">
          ...
          <div class="input-group mb-2 mr-sm-2">
            ...
            {!! Form::date(
              'fecha',
              $fecha->format('Y-m-d'),['id'=>'fecha_servicio',
