<div class="row">
  ...
  <div class="col-sm-4">
    <div class="btn-group alignright mb-2">
      ...
      @endif
      <button type="button" class="btn-sm btn btn-dark" data-toggle="modal" data-target="#ver_rayosx" id="btn_v_r"><i class="fa fa-search"></i></button>
    </div>
  </div>
</div>
<div class="flex-row">
	<center>
		<small class="form-text text-muted mb-1">Radiografías registrados la últimas 24 horas</small>
	</center>
</div>
@if ($count_r24 > 0)    
					...
					<div class="flex-row border py-1 rounded mb-3 alert-secondary text-dark">
						<div class="col-12">
							<div class="flex-row font-md">
								<b class="">{{$solicitud->rayox->nombre}}</b>
							</div>
							<div class="flex-row">
