<div class="row">
  ...
  <div class="col-sm-4">
    <div class="btn-group alignright mb-2">
      ...
      @endif
      <button type="button" class="btn-sm btn btn-dark" data-toggle="modal" data-target="#ver_tac" id="btn_v_t"><i class="fa fa-search"></i></button>
    </div>
  </div>
</div>
<div class="flex-row">
	<center>
		<small class="form-text text-muted mb-1">Tomografías registrados la últimas 24 horas</small>
	</center>
</div>
@if ($count_tac24 > 0)    
					...
					<div class="flex-row border py-1 rounded mb-3 alert-secondary text-dark">
						<div class="col-12">
							<div class="flex-row font-md">
								<b class="">{{$solicitud->tac->nombre}}</b>
							</div>
							<div class="flex-row">
...
@else
  <div class="flex-row" style="height: 184px; padding: 20px">
    ...
    <center>
      <span>No se ha registrado ningún tac al paciente en las últimas 24 horas</span>
    </center>
  </div>
@endif
