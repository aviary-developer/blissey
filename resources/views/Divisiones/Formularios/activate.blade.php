...
@if ($index)
  ...
  <button type="button" class="btn btn-danger btn-xs" onclick={!! "'eliminar(".$division->id.");'" !!}/>
...
@else
  <div class="btn-group">
    ...
    @if ($division->estado)
      <button type="button" class="btn btn-dark btn-ms" onclick={!! "'baja(".$division->id.");'" !!}>
        <i class="fa fa-trash"></i> Papelera
      </button>
    @else
      <button type="button" class="btn btn-dark btn-ms" onclick={!! "'alta(".$division->id.");'" !!}/>
        <i class="fa fa-check"></i> Restaurar
      </button>
      <button type="button" class="btn btn-danger btn-ms" onclick={!! "'eliminar(".$division->id.");'" !!}/>
