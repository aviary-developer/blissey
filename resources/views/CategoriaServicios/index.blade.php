      ...
      <div class="x_content">
        <div class="row">
          <div class="col-md-7 col-sm-7 col-xs-12">
            <div class="btn-group">
              <a href={!! asset('/categoria_servicios/create') !!} class="btn btn-dark btn-sm"><i class="fa fa-plus"></i> Nuevo</a>
              <a href={!! asset('#') !!} class="btn btn-dark btn-sm"><i class="fa fa-file"></i> Reporte</a>
              <a href={!! asset('/categoria_servicios?nombre='.$nombre.'&estado='.$estadoOpuesto) !!} class="btn btn-dark btn-sm">
                @if ($estadoOpuesto)
            ...
            @if (count($categoria_servicios)>0)
              ...
              @foreach ($categoria_servicios as $categoria_servicio)
                <tr>
                  ...
                  <td>
                    <a href={{asset('/categoria_servicios/'.$categoria_servicio->id)}}>
