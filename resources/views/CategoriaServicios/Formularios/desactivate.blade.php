...
<div class="btn-group">
	@if ($categoria_servicio->nombre == "Cama" || $categoria_servicio->nombre == "Laboratorio Clínico" || $categoria_servicio->nombre == "Ultrasonografía" || $categoria_servicio->nombre == "TAC" || $categoria_servicio->nombre == "Honorarios" || $categoria_servicio->nombre == "Rayos X")
