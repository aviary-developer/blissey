...
@if ($index)
  <a href={!! asset('/productos/'.$producto->id)!!} class="btn btn-xs btn-info">
    <i class="fa fa-info-circle"></i>
  </a>
  <a href={!! asset('/productos/'.$producto->id.'/edit')!!} class="btn btn-xs btn-primary">
    <i class="fa fa-edit"></i>
  </a>
  <button type="button" class="btn btn-success btn-xs" onclick={!! "'alta(".$producto->id.");'" !!}/>
...
@else
  <div class="btn-group">
    ...
    @else
      ...
      @endphp
    @endif
    <a href={!! asset('/productos'.$regreso)!!} class="btn btn-dark btn-ms">
      <i class="fa fa-arrow-left"></i> Atras
    </a>
    <a href={!! asset('/productos/'.$producto->id.'/edit')!!} class="btn btn-dark btn-ms">
      <i class="fa fa-edit"></i> Editar
    </a>
    @if ($producto->estado)
      <button type="button" class="btn btn-dark btn-ms" onclick={!! "'baja(".$producto->id.");'" !!}>
        <i class="fa fa-trash"></i> Papelera
      </button>
    @else
      <button type="button" class="btn btn-dark btn-ms" onclick={!! "'alta(".$producto->id.");'" !!}/>
        <i class="fa fa-check"></i> Restaurar
      </button>
      <button type="button" class="btn btn-danger btn-ms" onclick={!! "'eliminar(".$producto->id.");'" !!}/>
