<div class="modal fade bs-modal-sm" tabindex="-1" role="dialog" aria-hidden="true" id="modal1">
        ...
        <div class="x_panel">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
              ...
              {!! Form::text('nombre',null,['id'=>'nombrePresentacionModal','class'=>'form-control has-feedback-left','placeholder'=>'Nombre de la nueva presentación']) !!}
            </div>
          </div>
