<div class="modal fade" tabindex="-1" role="dialog" id="modal_division" data-backdrop="static" aria-hidden="true">
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="m_panel x_panel bg-transparent" style="border:0px !important">
          <center>
            <button type="button" class="btn btn-sm  col-2 btn-primary" id="guardarDivisionModal">Agregar</button>
