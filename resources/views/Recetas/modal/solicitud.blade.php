<div class="modal fade bs-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" id="solicitud_m" data-backdrop="static">
  <div class="modal-dialog">
            ...
            <div class="col-md-7 col-sm-7 col-xs-12">
              <div class="input-group">
                ...
                <span class="input-group-btn">
                  <button type="button" name="button" class="btn btn-primary" id="buscar_receta_s" data-tooltip="tooltip" title="Buscar Código">
    ...
    <div class="row" id="res_solicitud_m" hidden>
      <div class="col-xs-12">
        <div class="m_panel x_panel">
          ...
          <div class="row">
            <div id="cont_solicitud_m" class="row">
    ...
    <div class="row alignright">
      <button type="button" class="btn btn-sm btn-default" data-dismiss="modal" id="close-search-receta">Cerrar</button>
    </div>
  </div>
</div>