...
@if ($index)
  <div class="btn-group">
    <a href={!! asset('/componentes/'.$componente->id)!!} class="btn btn-sm btn-info"  title="Ver">
      <i class="fas fa-info-circle"></i>
    </a>
    <a href={!! asset('/componentes/'.$componente->id.'/edit')!!} class="btn btn-sm btn-primary"  title="Editar">
      <i class="fas fa-edit"></i>
    </a>
  </div>
  <div class="btn-group">
  <button type="button" class="btn btn-success btn-sm" onclick={!! "'alta(".$componente->id.");'" !!}  title="Restaurar"/>
