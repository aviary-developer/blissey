...
@if ($index)
  <a href={!! asset('/componente/'.$componente->id)!!} class="btn btn-xs btn-info">
    <i class="fa fa-info-circle"></i>
  </a>
  <a href={!! asset('/componente/'.$componente->id.'/edit')!!} class="btn btn-xs btn-primary">
    <i class="fa fa-edit"></i>
  </a>
  <button type="button" class="btn btn-success btn-xs" onclick={!! "'alta(".$componente->id.");'" !!}/>
    <i class="fa fa-check"></i>
  </button>
  <button type="button" class="btn btn-danger btn-xs" onclick={!! "'eliminar(".$componente->id.");'" !!}/>
...
@else
  <div class="btn-group">
    ...
    @if ($componente->estado)
      <button type="button" class="btn btn-dark btn-ms" onclick={!! "'baja(".$componente->id.");'" !!}>
        <i class="fa fa-trash"></i> Papelera
      </button>
    @else
      <button type="button" class="btn btn-dark btn-ms" onclick={!! "'alta(".$componente->id.");'" !!}/>
        <i class="fa fa-check"></i> Restaurar
      </button>
      <button type="button" class="btn btn-danger btn-ms" onclick={!! "'eliminar(".$componente->id.");'" !!}/>
