    ...
    <div class="input-group mb-2 mr-sm-2">
      ...
      {!! Form::text(
        ...
        ['class'=>'form-control form-control-sm',
          'placeholder'=>'Nombre de la ultrasonografía',
          'id'=>'nombre_ult_field']
      ) !!}
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="input-group mb-2 mr-sm-2">
      ...
      {!! Form::number(
        ...
        $valor,
        ['class'=>'form-control form-control-sm',
          'placeholder'=>'Precio de la ultrasonografía',
          'id'=>'precio_ult_field',
          'step'=>'0.01',
          'min'=>'0.00']
      ) !!}
...
<div class="x_panel">
  <center>
    ...
    <a href={!! asset('/ultrasonografias') !!} class="btn btn-light btn-sm">Cancelar</a>
  </center>
</div>

<script>
  $("#save_me").click(function(){
    var valido = new Validated('nombre_ult_field');
    valido.required();
    is_valid = valido.value(true);

    var valido = new Validated('precio_ult_field');
    valido.required();
