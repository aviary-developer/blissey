...
<div class="btn-group">
  ...
  @php
    $cuenta=App\ultrasonografia::foraneos($ultrasonografia->id);
  @endphp
  @if ($cuenta>0)
  ...
  @else
    <button type="button" class="btn btn-danger btn-sm" onclick={!! "'eliminar(".$ultrasonografia->id.");'" !!} title="Eliminar"/>
