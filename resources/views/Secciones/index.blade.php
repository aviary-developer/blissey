      ...
      <div class="x_content">
        <div class="row">
          <div class="col-md-7 col-xs-12">
            <div class="btn-group">
              <a href={!! asset('/secciones/create') !!} class="btn btn-dark btn-sm"><i class="fa fa-plus"></i> Nuevo</a>
              <a href={!! asset('#') !!} class="btn btn-dark btn-sm"><i class="fa fa-file"></i> Reporte</a>
              <a href={!! asset('/secciones?nombre='.$nombre.'&estado='.$estadoOpuesto) !!} class="btn btn-dark btn-sm">
                @if ($estadoOpuesto)
          ...
          <div class="col-md-5 col-xs-12">
            {!!Form::open(['route'=>'secciones.index','method'=>'GET','role'=>'search','class'=>'form-inline'])!!}
            ...
            @if (count($secciones)>0)
              ...
              @foreach ($secciones as $seccion)
                <tr>
                  ...
                  <td>
                    <a href={{asset('/secciones/'.$seccion->id)}}>
                      {{ $seccion->nombre }}
                    </a>
                  </td>
                  <td>
        ...
        <center>
          {!! str_replace ('/?', '?', $secciones->appends(Request::only(['nombre','estado']))->render ()) !!}
        </center>
      </div>
    </div>
  </div>
