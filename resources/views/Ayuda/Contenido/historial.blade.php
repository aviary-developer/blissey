...
@section('layout')
	...
	<div class="col-sm-10">
		<div class="x_panel">
			...
			<div class="flex-row">
				<center>
					<p>Registro de todos los procedimientos realizados por los usuarios.</p>
				</center>
			</div>
			...
			<div class="tab-content" id="myTabContent">
				...
				<div class="tab-pane fade show active" id="one" role="tabpanel" aria-labelledby="one-tab">
					...
					<iframe src={{asset('help/historial/Historial/Historial_player.html')}} frameborder="0" scrolling="no" width="100%" height="430px"></iframe>
				</div>				
