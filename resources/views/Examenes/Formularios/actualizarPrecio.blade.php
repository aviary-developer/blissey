  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Actualizar precio de {{$examen->nombreExamen}} <span class="label label-lg label-primary">Actualizar</span></h4>
      </div>
...
function guardarPrecio(idServicio,precio){
  var ruta='http://' + $('#guardarruta').val() + "/actualizarPrecioExamen";
