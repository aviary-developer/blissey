...
@if ($index)
  ...
  <button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Eliminar" onclick={!! "'eliminar(".$examen->id.");'" !!}/>
...
@else
  <div class="btn-group">
    ...
    @else
      <button type="button" class="btn btn-dark btn-sm" onclick={!! "'alta(".$examen->id.");'" !!}/>
        <i class="fa fa-check"></i> Restaurar
      </button>
      <button type="button" class="btn btn-danger btn-sm" onclick={!! "'eliminar(".$examen->id.");'" !!}/>
