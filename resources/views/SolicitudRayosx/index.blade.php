      ...
      <div class="x_content">
        <div class="row">
          <div class="col-md-12 col-sm-12 col-12">
            <div class="btn-group">
              <a href={{asset('/solicitudex/create?tipo=rayosx')}} class="btn btn-sm btn-dark">
              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href={{asset("/solicitudex?tipo=rayosx")}}>Por Radiografías</a>
                  </li>
                  <li><a href={{asset("/solicitudex?vista=paciente&tipo=rayosx")}}>Por Paciente</a>
                  </li>
                </ul>
              </div>
            ...
            <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
              @foreach($examenes as $k => $examen)
                <div class="panel">
                  <a class="panel-heading collapsed" role="tab" id={{"H".$k}} data-toggle="collapse" data-parent="#accordion" href={{"#C".$k}}        aria-expanded="false" aria-controls={{"C".$k}}>
                    <h4 class="panel-title">
                      {{$examen->rayox->nombre}} <small><i class="fa fa-chevron-down"></i></small>
                    </h4>
                  </a>
                  <div id={{"C".$k}} class="panel-collapse collapse" role="tabpanel" aria-labelledby={{"H".$k}}>
                    <div class="panel-body">
