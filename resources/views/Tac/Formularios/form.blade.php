    ...
    <div class="input-group mb-2 mr-sm-2">
      ...
      {!! Form::text(
        ...
        ['class'=>'form-control form-control-sm',
          'placeholder'=>'Nombre de la tomografía',
          'id'=>'nombre_tac_field']
      ) !!}
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="input-group mb-2 mr-sm-2">
      ...
      {!! Form::number(
        ...
        $valor,
        ['class'=>'form-control form-control-sm',
          'placeholder'=>'Precio de la tomografía',
          'id'=>'precio_campo',
          'step'=>'0.01',
          'min'=>'0.00']
      ) !!}
...
<div class="x_panel">
  <center>
    ...
    <a href={!! asset('/tacs') !!} class="btn btn-light btn-sm">Cancelar</a>
  </center>
</div>

<script>
  $("#save_me").click(function(){
    var valido = new Validated('nombre_tac_field');
    valido.required();
