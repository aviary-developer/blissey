<nav class="navbar navbar-expand-lg navbar-light  sticky-top mb-2" style="background-color: #e3f2fd;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link active" href={!! asset('/habitaciones/create') !!}>Nuevo</a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link active" href={!! asset('/ayuda/general?tipo=habitaciones') !!} target="_blank">Ayuda</a>
      </li>
    </ul>
