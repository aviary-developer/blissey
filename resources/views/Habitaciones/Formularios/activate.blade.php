...
@if ($index)
  ...
  <button type="button" class="btn btn-success btn-xs" onclick={!! "'alta(".$habitacion->id.");'" !!}/>
    <i class="fa fa-check"></i>
  </button>
  <button type="button" class="btn btn-danger btn-xs" onclick={!! "'eliminar(".$habitacion->id.");'" !!}/>
